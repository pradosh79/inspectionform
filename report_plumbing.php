...
<title>Property Inspection Report — <?php echo htmlspecialchars($record['client'], ENT_QUOTES, 'UTF-8'); ?></title>
<link rel="stylesheet" href="report.css">
</head>
<body>
<?php echo render_plumbing_report_html($record); ?>
...
<div style="text-align:center;margin-top:10px;">
  ...
  &nbsp;&nbsp;|&nbsp;&nbsp;
  <a href="reports_list_plumbing.php" style="color:#2E7D32;font-family:Arial,sans-serif;font-size:13px;">View previous reports</a>
</div>
...
document.getElementById('r-send-btn').addEventListener('click', async function(){
  ...
  try{
    var res = await fetch('api_plumbing.php?action=email_by_id', {
      method: 'POST',
